...
if "%PLATFORM%" == "msvc2019_64" set PACKAGE=win64_msvc2019_64
if "%PLATFORM%" == "msvc2019" set PACKAGE=win32_msvc2019
if "%PLATFORM%" == "winrt_x64_msvc2019" set PACKAGE=win64_msvc2019_winrt_x64
if "%PLATFORM%" == "winrt_x86_msvc2019" set PACKAGE=win64_msvc2019_winrt_x86
if "%PLATFORM%" == "winrt_armv7_msvc2019" set PACKAGE=win64_msvc2019_winrt_armv7
if "%PLATFORM%" == "msvc2019_64" set PACKAGE=win64_msvc2019_64
if "%PLATFORM%" == "msvc2019" set PACKAGE=win32_msvc2019
